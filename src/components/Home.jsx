...
const MenuPage = () => {
  return (
    <div className="fixed inset-0 bg-purple-200 z-10 flex flex-col items-center justify-center p-6 md:p-12 text-black overflow-auto">
      
      {/* Menu Content */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-center">
        {/* Services Column */}
        <div>
          <p className="text-2xl font-[font2] mb-8">Our superpower toolkit</p>
          <ul className="space-y-4 font-[font1]">
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">BRAND</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">DIGITAL</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">MARKETING</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">SOCIAL</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">DESIGN</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">BIDS & TENDERS</li>
          </ul>
        </div>
        
        {/* Projects Column */}
        <div>
          <p className="text-2xl font-[font2] mb-8">Projects</p>
          <ul className="space-y-4 font-[font1] mb-16">
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">CASE STUDIES</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">HOW WE WORK</li>
          </ul>
          
          <p className="text-2xl font-[font2] mb-8">Thoughts and musings</p>
          <ul className="space-y-4 font-[font1]">
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">NEWS & INSIGHTS</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">PODCASTS</li>
          </ul>
        </div>
        
        {/* Culture & Contact Column */}
        <div>
          <p className="text-2xl font-[font2] mb-8">Culture</p>
          <ul className="space-y-4 font-[font1] mb-16">
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">ABOUT US</li>
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">B CORP</li>
          </ul>
          
          <p className="text-2xl font-[font2] mb-8">Get in touch</p>
          <ul className="space-y-4 font-[font1]">
            <li className="text-5xl font-bold uppercase hover:opacity-70 cursor-pointer">CONTACT US</li>
          </ul>
        </div>
      </div>
