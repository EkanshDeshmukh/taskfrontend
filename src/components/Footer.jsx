...
const HelpSection = () => {
  return (
     <div className='w-full flex items-center justify-between'>
      ...
      <section className="px-4 bg-amber-400 md:px-8 lg:px-16 py-12 md:py-24">
      ...
      <section className="px-4 bg-blue-600 md:px-8 lg:px-16 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-1">
          <div className="bg-gray-800 inline-flex items-center rounded-full px-4 py-2 mb-6">
            ...
            <span className="bg-emerald-400 text-black ml-4 px-3 py-1 rounded-full text-sm">
              Website Carbon
            </span>
          </div>
...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Main Content and Newsletter Section */}
