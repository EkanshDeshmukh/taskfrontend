...
const HowWeWorkSection = () => {
  return (
    <div className="w-full min-h-screen bg-black text-white flex flex-col md:flex-row items-center justify-center p-8 md:p-20">
      {/* Left Section - Card with SVG */}
      <div className="w-64 h-64 bg-gradient-to-br from-pink-300 to-purple-500 rounded-2xl shadow-xl flex justify-center items-center mb-8 md:mb-0">
      ...
      <div className="max-w-2xl md:ml-12 text-center md:text-left">
        <h1 className="font1 text-4xl md:text-6xl font-extrabold mb-6 leading-tight">HOW WE WORK</h1>
        ...
        <button className="font2 border border-white rounded-full py-3 px-8 text-sm md:text-base flex items-center justify-center hover:bg-white hover:text-black transition-all duration-300">
